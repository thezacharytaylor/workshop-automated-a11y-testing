...
const EventsPage = () => {
  return (
    <BodyClassName className="header-overlap page-events">
      <>
        <HeaderPortal>
          <h1 className="visually-hidden">CampSpots Events</h1>
          <Helmet>
            <title>CampSpots Events</title>
          </Helmet>
        </HeaderPortal>
        <section>
          ...
          <article className="wide-layout two-parts-70-30">
            <div>
              ...
              <ul className="event-list">
                <li>
                  <a href="https://summermeltdown.com/">Summer Meltdown Festival 2022</a> - July 28-31, Sky Meadows Park
                  - Darrington, WA
                </li>
